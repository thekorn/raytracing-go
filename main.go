...
func main() {
	...
	world.Add(entities.MakeSphere(vec3.MakePoint3(0, 0, -1), 0.5, entities.MakeLambertian(vec3.MakeColor(0.1, 0.2, 0.5))))

	world.Add(entities.MakeSphere(vec3.MakePoint3(1, 0, -1), 0.5, entities.MakeMetal(vec3.MakeColor(0.8, 0.6, 0.2), 0.3)))
	world.Add(entities.MakeSphere(vec3.MakePoint3(-1, 0, -1), 0.5, entities.MakeDielectric(1.5)))
	world.Add(entities.MakeSphere(vec3.MakePoint3(-1, 0, -1), -0.45, entities.MakeDielectric(1.5)))
